        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(titl)) {
                    ...
                    Toast.makeText(addpost.this, "Title can't be left empty", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if (TextUtils.isEmpty(description)) {
                    ...
                    Toast.makeText(addpost.this, "Description can't be left empty", Toast.LENGTH_LONG).show();
                    return;
                }

                // If empty show error
                if (imageuri == null) {
                    Toast.makeText(addpost.this, "Select an Image", Toast.LENGTH_LONG).show();
                } else {
...
//        boolean result = ContextCompat.checkSelfPermission(addpost.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
...
//                        pickFromCamera();
//                    } else {
//                        Toast.makeText(addpost.this, "Please Enable Camera and Storage Permissions", Toast.LENGTH_LONG).show();
//                    }
//                }
//            }
//
...
//                        pickFromGallery();
//                    } else {
//                        Toast.makeText(addpost.this, "Please Enable Storage Permissions", Toast.LENGTH_LONG).show();
//                    }
//                }
//            }
//            break;
...
//        imageuri = new addpost().getContentResolver().insert(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, contentValues);
                    ...
                    databaseReference.child(timestamp).setValue(hashMap)
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    pd.dismiss();
                                    Toast.makeText(addpost.this, "Published", Toast.LENGTH_LONG).show();
                                    title.setText("");
                                    des.setText("");
                        ...
                        public void onFailure(@NonNull Exception e) {
                            pd.dismiss();
                            Toast.makeText(addpost.this, "Failed", Toast.LENGTH_LONG).show();
                        }
                    });
                }
            }
