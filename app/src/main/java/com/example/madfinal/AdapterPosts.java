...
public class AdapterPosts extends RecyclerView.Adapter<com.example.madfinal.AdapterPosts.MyHolder> {
...
//    ValueEventListener context, List<ModelPost> modelPosts
    public AdapterPosts(List<ModelPost> list, Context context) {
